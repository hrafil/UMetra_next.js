                  ...
                  <ul>
                    {entryAttr[attr].map((attrValue, attrValueKey) => {
                      ...
                      const checked = this.props.filters[attr]
                        ? this.props.filters[attr].includes(
                            attrValue.toString(),
                          )
                        : false;
                      return (
...
const Pagination = class Pagination extends React.Component {
  render() {
    ...
    const displayMin =
      pages > 10 ? (this.props.page - 5 < 1 ? 1 : this.props.page - 5) : 1;
    const displayMax =
      pages > 10
    ...
    return (
      <ul className="pagination">
        ...
        {_.range(displayMin, displayMax).map((page, i) => {
          return (
            <li>
              <button
                type="button"
        ...
        <li>
          <button
            ...
            disabled={
              this.props.page + 1 >=
              this.props.entries.length / ENTRIES_PER_PAGE
            }
          >
            Next
          </button>
    ...
    return (
      <section className="body">
        <header className="body__header">
          <h2 className="body__header__title">
            Entries ({paginationOffset + 1}-
            {paginationOffset + paginatedEntries.length} of {entries.length})
          </h2>
        </header>
